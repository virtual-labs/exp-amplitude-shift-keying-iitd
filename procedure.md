    ...
    <ul>
      ...
      <h3>Steps:</h3>
        ...
        <li>
            ...
            First click <em>“Simulate”</em> to perform the modulation (ASK, FSK, or PSK) on the randomly generated message signal using the generated carrier. Once the modulated signal is generated, click <em>“Demodulate”</em> to recover the message from it. Demodulation requires modulation to have been performed first.
        </li>
        <li>
